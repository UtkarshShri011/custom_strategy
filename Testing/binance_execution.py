...
from base import CopyTradingStrategy,CopyTradingConfig
...
config_node = TradingNodeConfig(
    ...
    data_clients={
        "BINANCE": BinanceDataClientConfig(
            ...
            api_key="f6120805ad848210623d784e22b412e9e6bd8cc89ffea7194d5cce69e81525a7",  # 'BINANCE_API_KEY' env var
            api_secret="5a708ef8b6fd809022e76f73dbf0306ea3be461603a36cdca7ba950eb338564b",  # 'BINANCE_API_SECRET' env var
            testnet=True,
...
if __name__ == "__main__":
    try:
        ...
        #thread_2.join()
        node.run()
        run_statistics_periodically(node)
    finally:
        node.dispose()
